        ...
        $menu = [
            'button'    => [
                ...
                [
                  'type'  => 'view',
                  'name'  => '商场',
                  'url'   => 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx862686ded89ed2cd&redirect_uri='.$redirect_uri2.'&response_type=code&scope=snsapi_userinfo&state=ABCD1905#wechat_redirect'
                ],
            ]
        ];
